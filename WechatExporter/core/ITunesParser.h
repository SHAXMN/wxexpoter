...
public:
    ...
    bool scanDocumentAttachments(std::vector<AttachmentInfo>& attachments) const;
    int copyAttachments(const std::vector<AttachmentInfo>& attachments, const std::string& outputPath) const;
